...
public class parittapanna extends AppCompatActivity implements View.OnClickListener {
    Button namakaragathaintent;
    Button pubbabhaganamakaraintent;
    Button pancasilaintent;
    Button tisaranaintent;
    Button buddhanusatiintent;
    Button dhammanusatiintent;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_parittapanna);
        ...
        buddhanusatiintent = (Button)findViewById(R.id.buddhanusati);
        buddhanusatiintent.setOnClickListener(this);
        dhammanusatiintent = (Button)findViewById(R.id.dhammanusati);
        dhammanusatiintent.setOnClickListener(this);
    }
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.tisarana:
                ...
                break;
            case R.id.buddhanusati:
                Intent buddhanusati = new Intent(Intent.ACTION_VIEW, Uri.parse("https://docs.google.com/document/d/1sMuXLmRc9ei4so7FQvkIwSiVMrDcg80s/edit?usp=sharing&ouid=101188777282539998841&rtpof=true&sd=true"));
                startActivity(buddhanusati);
                break;
            case R.id.dhammanusati:
                Intent dhammanusati = new Intent(Intent.ACTION_VIEW, Uri.parse("https://docs.google.com/document/d/1qBHsla13zTAx4AYKrkdILz4a93AFq1rm/edit?usp=sharing&ouid=101188777282539998841&rtpof=true&sd=true"));
                startActivity(dhammanusati);
                break;
            default:
                break;
        }
