...
public class updatebiodatafasilitator extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_updatebiodatafasilitator);
        ...
        text3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(
                        updatebiodatafasilitator.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
